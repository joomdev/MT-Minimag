...
( function ( $ ) {
	...
	wp.customize( 'blogname', function( value ) {
		value.bind( function( newval ) {
			$( '.mt-logo-text a' ).text( newval );
		} );
	} );
	wp.customize( 'blogdescription', function( value ) {
		value.bind( function( newval ) {
			$( '.mt-logo-text .brand-tagline' ).text( newval );
		} );
	} );
	...
	wp.customize( 'offcanvas_width', function( value ) {
		value.bind( function( newval ) {
			newval = newval+"px";
			document.documentElement.style.setProperty('--offcanvas-width', newval);
		});
	});
	wp.customize( 'color_offcanvas', function( value ) {
		value.bind( function( newval ) {
			document.documentElement.style.setProperty('--offcanvas-text-color', newval);
		});
	});
	wp.customize( 'color_offcanvas_bg', function( value ) {
		value.bind( function( newval ) {
			document.documentElement.style.setProperty('--offcanvas-bg', newval);
		});
	});
	...
	wp.customize( 'color_boxed_background', function( value ) {
		value.bind( function( newval ) {
			$('.big-container').css('background-color', newval);
		});
	});
	...
	wp.customize( 'color_logo_text', function( value ) {
		value.bind( function( newval ) {
			$('.mt-logo-text .brand-title').css('color', newval);
		});
	});
	...
	wp.customize( 'color_copyright_bg', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( '404_page_content', function( value ) {
		value.bind( function( newval ) {
			$('.page-content-404 .404-content').html(newval);
		})
	});
	wp.customize( 'calltoaction', function( value ) {
		value.bind( function( newval ) {
			$('.page-content-404 .404-cta').html(newval);
		})
	});
