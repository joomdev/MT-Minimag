...
(function () {
	wp.customize.bind('ready', function () {
		...
		wp.customize('enable_slider', function (setting) {
			wp.customize.control('category_type', function (control) {
				var visibility = function () {
					if ('1' == setting.get()) {
						control.container.slideDown(180);
					} else {
			...
			wp.customize.control('no_of_posts', function (control) {
				var visibility = function () {
					if ('1' == setting.get()) {
						control.container.slideDown(180);
					} else {
			...
			wp.customize.control('sort_posts', function (control) {
				var visibility = function () {
					if ('1' == setting.get()) {
						control.container.slideDown(180);
					} else {
		...
		// Show Offcanvas controls
		wp.customize('enable_offcanvas', function (setting) {
			wp.customize.control('offcanvas_width', function (control) {
				var visibility = function () {
					if ('1' == setting.get()) {
						control.container.slideDown(180);
					} else {
			...
			wp.customize.control('color_offcanvas', function (control) {
				var visibility = function () {
					if ('1' == setting.get()) {
						control.container.slideDown(180);
					} else {
			...
			wp.customize.control('color_offcanvas_bg', function (control) {
				var visibility = function () {
					if ('1' == setting.get()) {
						control.container.slideDown(180);
					} else {
